...
- (instancetype)init {
    if ((self = [super initWithFrame:CGRectMake((APPDELEGATE.window.frame.size.width - Size.width*0.125)/2, (APPDELEGATE.window.frame.size.height - Size.width*0.125)/2, Size.width*0.125, Size.width*0.125)])) {
